...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL,Void,String>
    {
        ...
        protected void onPreExecute() {
            mSearchResultsTextView.setText("waiting...");
        }

        @Override
        protected String doInBackground(URL... params) {
            URL searchUrl = params[0];
            String githubSearchingResults = null;

            try {
                githubSearchingResults = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
            return githubSearchingResults;
        }
